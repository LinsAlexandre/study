...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card sx={{backgroundColor: '#fff'}}>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    <TableRow
                    key={indice}
                    sx={{ '&:last-child td, &:last-child th': { border: 0 }, backgroundColor: ()=> {
                      if(row.statusTarefa === "Concluída"){
                        return '#c8e6c9';
                      } else if (row.statusTarefa === "Em Andamento") {                          
                        return '#fff9c4';
                      } else{
                        return '#ffcdd2';
                      }
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} sx={{backgroundColor:'#ff9800' }}>Criar Tarefa</Button>
            <Button size="small" variant="outlined" sx={{color:'#ff9800', borderColor:'#ff9800'}}>Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
